...
ElectroServer.prototype.initialize = function() {
    /**
     * @property {EsEngine} engine
     */
    this.engine = new ElectroServer.EsEngine();
    /**
     * @property {ManagerHelper} managerHelper
     */
 ...
 * @param listener
 */
ElectroServer.EventDispatcher.prototype.removeEventListener = function(eventType, listener) {
	if (this.listeners[eventType] instanceof Array){
        var listeners = this.listeners[eventType];
        for (var i=0, len=listeners.length; i < len; i++){
...
/**
 * @constructor EsEngine 
 * Creates a new instance of the ESEngine.  EsEngine represents the lowest level API. Creating an instance of EsEngine directly and using it gives you access to all of the raw events.
 * This API is stateless, so it doesn't keep track of which rooms you may be in, the users you know about, room variables, user variables, etc. For
 * that level of API see the ElectroServer class.
 */
...
/**
 * @function addServer Adds a Server instance to the list of available servers. Servers should only be added through this method or by setting a new array of servers via the 'servers' property.
...
/**
 * @function removeServer Removes a server from the list of available servers.
...
/**
 * @function send 
 * Sends a message to the server. This is the only way to communicate with the server. 
 * If no connection is specified then the default connection is used.  
 * The default connection is the first connection established.
 * @param	message The message to send to the server.
 * @param	{optional Connection} connection The optional connection to use for sending to the server.
 */
 ...
 *
 * @param	{optional Server} Optional Server instance. This needs to have already been added to this class via the servers property or addServer method.
 * @param	{optional AvailableConnection} Optional AvailableConnection instance. If non-null then the 'server' parameter must be non-null and this instance must have been added to it.
 */
 ...
 * @param   {String}  Id of the Server instance to return
 ...
 * @param   {int} Id of the Connection you want to retrieve
...
ElectroServer.Server = function(serverId) {
	...
	this.serverId = serverId;
        ...
        /**
         * @property {Array} activeConnections
         */
	this.activeConnections = new Array();
        
        /**
         * @property {Array} availableConnections
         */
	...
	this.expectedMessageNumber = 0;
        ...
        /**
         * @property {Array} queuedMessages
         */
	this.queuedMessages = new Array();
        
        /**
         * @property {Array} availableConnectionsByType
         */
...
/**
 * @function addAvailableConnection
 * Adds an AvailableConnection object to the list of available connections.
 * @param {AvailableConnection}	The AvailableConnection object to store.
 */
...
/**
 * @function removeAvailableConnection
 * Removes an AvailableConnection object.
 * @param {AvailableConnection}	Object to remove.
 */
...
/**
 * @function {Array} getAvailableConnectionsByType
...
/**
 * @constructor AvailableConnection
 * @param {String} host
 * @param {int} port
 ...
 * @param {AvailableConnection} availableConnection
 */
...
/**
 * @function {int} getNextOutboundId
 * @returns next outbound id
 */
...
/**
 * @property ConnectionEvent
 * Value is one of CONNECTION_ESTABLISHED, CONNECTION_CLOSED, CONNECTION_FAILED
 */
ElectroServer.ConnectionEvent = {
	CONNECTION_ESTABLISHED : "ElectroServer.ConnectionEvent.CONNECTION_ESTABLISHED",
	CONNECTION_CLOSED : "ElectroServer.ConnectionEvent.CONNECTION_CLOSED",
	CONNECTION_FAILED : "ElectroServer.ConnectionEvent.CONNECTION_FAILED",
}
...
ElectroServer.HttpConnection.prototype.connectionFailed = function() {
	this.dispatchEvent(ElectroServer.ConnectionEvent.CONNECTION_FAILED, this);
};
...
ElectroServer.HttpConnection.Worker.prototype = {
    //Gets the browser specific XmlHttpRequest Object
/**
 * @function {XmlHttpRequest} getXmlHttpRequestObject
 * @returns object
 */
getXmlHttpRequestObject : function() {
	...
	send : function(url, data) {
		...
		this.request.send(data ? data : null);
	},
    ...
    handler : function() {
    	if (this.request.readyState == 4) {
    		if (this.request.status != 200) {
    			this.connection.connectionFailed();
    			return;
    		}
    		var buffer = new ByteBuffer();
...
ElectroServer.EsObject.prototype = {
    ...
    /**
     * @function setEsObject
     * @param {String} name
     * @param {EsObject} value
     */
	...
	getEsObject : function(name, type) {
        ...
        /**
         * @function {Array} getEsObjectArray
         * @param {String} name
         * @param {DataType} type
         * @returns value
         */
	getEsObjectArray : function(name, type) {
        ...
        /**
         * @function {Array} getIntegerArray
         * @param {String} name
         * @param {DataType} type
         * @returns value
         */
	...
	getFloatArray : function(name, type) {
        ...
        /**
         * @function {Array} getBooleanArray
         * @param {String} name
         * @param {DataType} type
         * @returns value
         */
	...
	getByteArray : function(name, type) {
        ...
        /**
         * @function {Array} getCharacterArray
         * @param {String} name
         * @param {DataType} type
         * @returns value
         */
	...
	getNumberArray : function(name, type) {
        ...
        /**
         * @function {int} size
         * @returns number of variables stored in the EsObject
         */
	size : function() {
    	var size = 0;
...
ElectroServer.User = function() {
    ...
    /**
     * @property {BuddyVariable} buddyVariable
     */
...
ElectroServer.UserManager = function() {
    ...
    /**
     * @property {Array} referencesByUser
     */
...
/**
 * @function {Boolean} doesUserExist
...
/**
 * @function {User} userByName
 * Gets a user by name.
 * @param {String} The name of the user to find. Returns null if there is no user with that name being tracked.
...
ElectroServer.Room = function() {
     ...
     * Password will only be non-null if the Room has a password and 
     * this user is in the room.
     */
    this.password = null;
    /**
     * @property {Array} roomVariables
     */
    this.roomVariables = new Array();
    /**
     * @property {Array} roomVariablesByName
     */
    this.roomVariablesByName = {};
    /**
     * @property {Boolean} isJoined
     * Default is false.  Will be true if this user is joined to this room.
     */
    this.isJoined = false;
}
...
/**
 * @function {RoomVariable} roomVariableByName
 * Gets a RoomVariable object by name.
 * @param	{String} Name of the variable to find.
 * @returns RoomVariable object that has the name passed in.
 */
...
ElectroServer.Zone = function() {
    ...
    this.rooms = new Array();
    /**
     * @property {Array} roomsById
     */
    this.roomsById = new Array();
    /**
     * @property {Array} roomsByName
     */
    this.roomsByName = {};
}
 ...
 * @function roomByName
 * Gets a Room by name.
 * @param {String} Name of the room to return.
 ...
 * @function roomById
 * Gets a Room by id.
 * @param {int}	Id of the room to return.
 ...
 * Manages the list of zones that you should know about based on the rooms that you are in. 
...
ElectroServer.ZoneManager = function() {
    ...
    this.zones = new Array();
    /**
     * @property {Array} zonesById
     */
    this.zonesById = new Array();
    /**
     * @property {Array} zonesByName
     */
    this.zonesByName = {};
}
 ...
 * @function zoneByName
 * Gets a zone by name.
 * @param	{String} Name of the zone to find.
 ...
 * @function zoneById
 * Gets a zone by id.
 * @param	{int} Id of the zone to find.
...
/**
 * @constructor ManagerHelper 
 * Listens for many ElectroServer events so that it can manage the 
...
ElectroServer.ManagerHelper = function() {
    ...
    /**
     * @property {ZoneManager} zoneManager
     */
...
ElectroServer.ManagerHelper.prototype.registerListeners = function() {
    ...
    /**
     * @function onRemoveBuddiesResponse
 ...
 * @param	{User} u that owns the variables
 * @param	{Array} arr of UserVariables
 */
